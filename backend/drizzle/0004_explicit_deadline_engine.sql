...
DROP TABLE IF EXISTS "deadline_markets" CASCADE;
...
CREATE UNIQUE INDEX "event_families_slug_idx" ON "event_families" ("slug");
CREATE INDEX "event_families_kind_idx" ON "event_families" ("family_kind");
CREATE INDEX "event_families_updated_at_idx" ON "event_families" ("updated_at");
...
CREATE INDEX "orderbook_snapshots_token_idx" ON "orderbook_snapshots" ("token_id");
CREATE INDEX "orderbook_snapshots_created_at_idx" ON "orderbook_snapshots" ("created_at");
CREATE INDEX "st_market_id_idx" ON "simulated_trades" ("market_id");
CREATE INDEX "st_status_idx" ON "simulated_trades" ("status");
CREATE INDEX "st_entry_ts_idx" ON "simulated_trades" ("entry_ts");
CREATE UNIQUE INDEX "uq_open_trade_per_deadline_token" ON "simulated_trades" ("market_id", "token_id") WHERE status = 'OPEN';
